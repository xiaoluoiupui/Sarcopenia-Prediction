...
for allow_iter in [50, 60, 70, 80]: # 30, 50, 80
    for alp in [1, 2, 5, 10, 50]: # 1, 2, 5, 10, 20, 30, 40, 50
        # fill parameter
        model = MLPClassifier(random_state=6, max_iter=allow_iter, alpha=alp)
        ...
        """iter=30, alp=30 70.1 (4.22) & 74.32 (0.53)]"""

        print('allow_iter=', allow_iter, 'alp=', alp, '&', a, '&', b)

        k = 'allow_iter=' + str(allow_iter) + ', alp=' + str(alp)
        v = a, b
        if 0 < v[1] - v[0] <=10:
            overall_dict[k] = v
...
"""Best parameters: allow_iter=60, alp=50
test:  71.58 val:  66.84 train:  71.16
Best parameters: allow_iter=80, alp=50
test:  71.59 val:  66.99 train:  70.64
Best parameters: allow_iter=50, alp=50
test:  71.85 val:  67.06 train:  71.3
Best parameters: allow_iter=70, alp=50
test:  71.56 val:  67.59 train:  71.21
Best parameters: allow_iter=60, alp=10
test:  71.29 val:  69.2 train:  75.76
Best parameters: allow_iter=70, alp=10
test:  71.45 val:  69.34 train:  76.05
Best parameters: allow_iter=80, alp=10
test:  71.45 val:  69.34 train:  76.05
Best parameters: allow_iter=50, alp=10
test:  71.83 val:  69.66 train:  76.31
Best parameters: allow_iter=70, alp=5
test:  71.25 val:  72.04 train:  82.0
Best parameters: allow_iter=80, alp=5
test:  70.99 val:  72.04 train:  81.55
